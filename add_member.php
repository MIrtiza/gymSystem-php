				...
				<div class="agileinfo-cdr">
                    ...
                    <div class="form-body">
                        <form action="action.php" method="post"> 
                             ...
                             <div class="form-group"> 
                                <label for="">NIC</label> 
                                 <input type="text" class="form-control" name="nic" id="" placeholder="NIC Number" required> 
                             </div>
                            <div class="form-group"> 
                                <label for="">Addmission Date</label> 
                                 <input type="date" class="form-control" name="date" id="" placeholder="Date" required> 
                             </div> 
