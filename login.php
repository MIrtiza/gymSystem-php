...
.login-page input.user {
    background: url(images/user.png)no-repeat 8px 16px rgb(184, 183, 183);
}
</style>
</head> 
...
<div class="main-content">
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form action="login.php" method="post">
							<input type="text" class="user" name="username" placeholder="Enter Your Username" required="" style=" font-size: 1em;
    ...
    margin: 0em 0em 1.5em 0em;">
		...
		<!--footer-->
		<div class="footer">
		   <p>&copy; 2018 Hyper Gym All Rights Reserved | Design by <a href="https://www.fb.com/hashsystemic" target="_blank">Hash Systemic</a></p>		</div>
        <!--//footer-->
	</div>
