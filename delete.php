				...
				<div class="agileinfo-cdr">
                    ...
                    <div class="form-body">
                        <form action="action.php" method="post"> 
                           <select name="uid" id="" style="width: 100%; height: 50px; padding:10px;">
                               ...
                               ?>
                               <option value="<?php echo $row['uid'];?>" name="uid">
                                <?php echo $row['uid']. " : ". $row['user_name'];?>
                              </option>

                              <?php }?>
                           </select>
                                <br><br>
                                <button type="submit" name="delete" class="btn btn-default" style="width: 100%;">Submit</button> 
                          </form> 
                    </div>
